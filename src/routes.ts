...
router.post("/partners/create", keycloak.protect("edit"), PartnerController.savePartner)
...
router.post("/modalities/create", keycloak.protect("edit"), ModalityController.saveModality)
...
router.post("/contracts/create", keycloak.protect("edit"), ContractController.saveOneContract)
